...
class Plateau:
    ...
    def animal_tree(self, elem_plateau, animal_subcat, tree_subcat,
                    # up=False, down=False, left=False, right=False,
                    p=5):
        points = 0
        # if up:
        # print(elem_plateau)
        if elem_plateau == animal_subcat and elem_plateau["arbre"].subcategory == tree_subcat:
                points += p
        # if down:
        #     if elem_plateau["down"].subcategory == animal_subcat and elem_plateau["arbre"].subcategory == tree_subcat:
        #         points += p
        # if left:
        #     if elem_plateau["left"].subcategory == animal_subcat and elem_plateau["arbre"].subcategory == tree_subcat:
        #         points += p
        # if right:
        #     if elem_plateau["right"].subcategory == animal_subcat and elem_plateau["arbre"].subcategory == tree_subcat:
        #         points += p
            ...
            # Oiseau
                ...
                for dict_ in self.plateau_player:
                    ...
                    for elem in list(dict_.values()):
                        if elem !=None:
                            points = self.animal_tree(self, elem_plateau=elem["up"].subcategory, animal_subcat="pinson_des_arbres", tree_subcat="hêtre",p=5)
                print(f"{animal.subcategory} += {points} points.")
                return points
